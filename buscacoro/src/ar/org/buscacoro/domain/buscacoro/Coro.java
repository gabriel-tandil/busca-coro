 ...
 * <p>Title: Coro</p>
 *
 * <p>Description: Domain Object describing a Coro entity</p>
 *
 */
@Entity (name="Coro")
@Table (name="coro")
@Views({
// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @view-base-coro@// No ending comment snippet from this extension 
	@View(
		name="base",
		members=
        "" 	
...
// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @view-reference-coro@// No ending comment snippet from this extension 
    @View(name="reference", 
       extendsView="coroDEFAULT_VIEW"
// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-ENDING// No ending comment snippet from this extension 
    )
})
...
// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @parent-Ciudad-coro@// No ending comment snippet from this extension 
...
// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-ENDING// No ending comment snippet from this extension 
// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @parent-Tipo-coro@// No ending comment snippet from this extension 
    @ManyToOne (fetch=FetchType.LAZY ,optional=false) //remove optional=false to aggragate but leads to a side effect when going directly to the entity: required check is not performed=> if no set DB check constraint is raised...
...
// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-coro@// No ending comment snippet from this extension 
    @javax.persistence.PrePersist
    public void prePersist_ () {
    }
// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-ENDING// No ending comment snippet from this extension 

// No beginning comment snippet from this extension MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-coro@// No ending comment snippet from this extension 
